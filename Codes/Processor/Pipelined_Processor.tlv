...
\TLV
   ...
   |cpu
      ...
      @1
         ...
         // Decode Other Fields - OpCode, Register Etc
         ...
         // Decode Instruction Fields for Function
      ...
      @2
         ...
         // Read from Register Files (2-Reads)
         ...
         // ALU Input Assignment and Avoid RAW Hazard
      ...
      @3
         ...
         $result[31:0] = $is_add   ? $src1_value +  $src2_value      : 
                         ...
                         $is_sltu  ? $src1_value <  $src2_value[4:0] :
                         $is_andi  ? $src1_value & $src2_value       :
                         $is_ori   ? $src1_value | $src2_value       :
                         $is_xori  ? $src1_value ^ $src2_value       :
                         
                         // I-Type Instruction Operations
         ...
         $rf_wr_en = $valid ? ($rd == 5'h0) ? 1'b0 : $rd_valid : 1'b0;
   ...
   *failed = 1'b0;
   ...
   |cpu
      m4+imem(@1)      // Instruction Memory (Read)
      m4+rf(@2, @3)    // Register File (Read, Write)
      m4+dmem(@4)      // Data Memory (Read / Write)
